...
import { RANKING_TYPES, rankingHref, type RankingType } from "@/entities/ranking";
...
async function readParams(params: RankingPageProps["params"]) {
  ...
  return { type: type as RankingType, segments: filters ?? [], filters: parsed };
}
...
export default async function RankingPage({
  ...
  return renderRankingPage(type, filters, await searchParams);
}
